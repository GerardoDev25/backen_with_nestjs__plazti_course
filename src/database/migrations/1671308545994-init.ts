...
export class init1671308545994 implements MigrationInterface {
  name = 'init1671308545994';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "category_products_products" ("categoryId" integer NOT NULL, "productsId" integer NOT NULL, CONSTRAINT "PK_e3d34c2352e8f5b24ab5f9776b2" PRIMARY KEY ("categoryId", "productsId"))`,
    );
    await queryRunner.query(
